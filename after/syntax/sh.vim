...
syntax match shLibs "^\s*\zs\%(iconv\|php\|convert\|youtube-dl\|ffmpeg\|ffprobe\|find\|fzf\|complete\|alias\|unalias\|alias\)\ze\s.*$" containedin=shIf,shFunctionOne,shCommandSub,shDo
...
highlight! link shLibs Function
